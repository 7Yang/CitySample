...
public:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Mass Traffic|Traffic Vehicle")
	void OnDriverRemoved(const FMassTrafficDriverTypeData& DriverTypeData, const FMassTrafficInstancePlaybackData& DriverInstanceData, const FTransform& DriverTransformWorldSpace);
};
