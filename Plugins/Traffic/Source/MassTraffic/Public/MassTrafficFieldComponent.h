...
public:	
	...
	FORCEINLINE const TArray<FZoneGraphTrafficLaneData*>& GetTrafficLanes() const { return TrafficLanes; }
	
	FORCEINLINE const TArray<FMassEntityHandle>& GetTrafficIntersectionEntities() const { return TrafficIntersectionEntities; }
