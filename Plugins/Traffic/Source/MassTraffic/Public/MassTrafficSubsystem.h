...
public:
	...
	const TArray<TObjectPtr<UMassTrafficFieldComponent>>& GetFields() const { return Fields; }
	...
	/**
	 * Extracts and caches Mass Traffic vehicle physics simulation configuration, used for medium LOD traffic vehicle simulation.
	 */
