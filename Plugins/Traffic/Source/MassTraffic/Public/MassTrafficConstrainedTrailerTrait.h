...
/**
 * In concert with UMassTrafficTrailerSpawnDataGenerator, 
 * spawns a TrailerAgentConfigAsset entity and point constrains its vehicle simulation to this vehicle.
 */
