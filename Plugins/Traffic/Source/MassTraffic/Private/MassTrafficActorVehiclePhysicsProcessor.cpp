		...
		for (int32 Index = 0; Index < NumEntities; ++Index)
		{
			...
			if (Actor != nullptr && Actor->Implements<UMassTrafficVehicleControlInterface>())
			{
				...
				else
				{
					...
					{
						IMassTrafficVehicleControlInterface::Execute_SetVehicleInputs(Actor, PIDVehicleControlFragment.Throttle, PIDVehicleControlFragment.Brake, PIDVehicleControlFragment.bHandbrake, PIDVehicleControlFragment.Steering, /*bSetSteering*/ true);
					});
				}
			}
		}
