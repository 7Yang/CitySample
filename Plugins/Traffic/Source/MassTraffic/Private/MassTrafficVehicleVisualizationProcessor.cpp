...
FMassTrafficVehicleInstanceCustomData FMassTrafficVehicleInstanceCustomData::MakeTrafficVehicleCustomData(const FMassTrafficVehicleLightsFragment& VehicleStateFragment, const FMassTrafficRandomFractionFragment& RandomFractionFragment)
{
...
FMassTrafficVehicleInstanceCustomData FMassTrafficVehicleInstanceCustomData::MakeParkedVehicleCustomData(const FMassTrafficRandomFractionFragment& RandomFractionFragment)
{
...
FMassTrafficVehicleInstanceCustomData FMassTrafficVehicleInstanceCustomData::MakeTrafficVehicleTrailerCustomData(const FMassTrafficRandomFractionFragment& RandomFractionFragment)
{
			...
			// Update active representation
			{
				...
				switch (RepresentationFragment.CurrentRepresentation)
				{
					case EMassRepresentationType::StaticMeshInstance:
					{
						...
						{
							ISMInfo[RepresentationFragment.StaticMeshDescHandle.ToIndex()].AddBatchedTransform(Entity, TransformFragment.GetTransform(), RepresentationFragment.PrevTransform, RepresentationLODFragment.LODSignificance);
