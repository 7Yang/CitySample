...
AHoverDronePawn::AHoverDronePawn(const FObjectInitializer& ObjectInitializer) 
    : Super(ObjectInitializer.SetDefaultSubobjectClass<UHoverDroneMovementComponent>(ADefaultPawn::MovementComponentName).SetDefaultSubobjectClass<UCameraComponent>(AHoverDronePawnBase::CameraComponentName))
{
