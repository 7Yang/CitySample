...
void ParseAlembicArrayAttribute(int InDataExtent, const Alembic::AbcGeom::ICompoundProperty& Parameters, const FString& InPropName, int InNumPoints, TArray<FString>& OutMetadataColumnNames, TMap<FString, TArray<FString>>& OutMetadataValues);
 ...
 */
template <typename AbcParamType, typename AbcArraySampleType, typename AttributeType>
void ParseAlembicVectorAttribute(const Alembic::AbcGeom::ICompoundProperty& Parameters, const FString& InPropName, int InNumPoints, int InExtent, TArray<FString>& OutMetadataColumnNames, TMap<FString, TArray<FString>>& OutMetadataValues);
