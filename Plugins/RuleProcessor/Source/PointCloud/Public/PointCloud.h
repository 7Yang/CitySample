...
public:
	...
	*/
	virtual bool InitFromPreparedData(const FString& ObjectName, TArray<FTransform>& PreparedTransforms, TArray<FString>& MetadataColumnNames, TArray<int>& MetadataCountPerVertex, TArray<TPair<int, FString>>& PreparedMetadata, const FBox& ImportBounds, FFeedbackContext* Warn = nullptr ) PURE_VIRTUAL(UPointCloud::InitFromPreparedData, return false;)
