...
public:
	...
	FMinimalViewInfo GetTransitionGoalPOV() const { return TransitionGoalPOV; }
	...
	UFUNCTION(BlueprintCallable)
	bool IsUsingAlternateCamera() const { return bUsingAltCameraMode; }

	bool HasAlternateCameraAvailable() const { return AltCameraMode != nullptr; }
