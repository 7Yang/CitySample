...
public:
	...
	UFUNCTION(BlueprintPure)
	float GetDesiredWalkSpeed() const { return DefaultWalkSpeed; }

	UFUNCTION(BlueprintPure)
	float GetDesiredSprintSpeed() const { return DefaultSprintSpeed; }

	UFUNCTION(BlueprintPure)
	float GetDesiredWalkMinInputSize() const { return DefaultWalkMinInputSize; }

	UFUNCTION(BlueprintPure)
	float GetDesiredSprintMinInputSize() const { return DefaultSprintMinInputSize; }
