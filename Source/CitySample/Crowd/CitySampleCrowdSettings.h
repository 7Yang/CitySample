...
public:
	...
	static UCitySampleCrowdSettings* GetMutable() { return GetMutableDefault<UCitySampleCrowdSettings>(); }

	UFUNCTION(BlueprintCallable)
	static const UCitySampleCrowdSettings* Get() { return GetDefault<UCitySampleCrowdSettings>(); }
