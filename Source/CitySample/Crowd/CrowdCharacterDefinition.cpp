...
namespace CitySample { namespace Crowd 
{
...
void FCrowdHairDefinition::UpdateGroomBinding(const FSoftObjectPath& PathToHeadMesh, const ECitySampleCrowdGender Skeleton)
{
	...
	static const TArray<FString> BasePaths = { "/Game/Crowd/Character/Male/GroomBindings", "/Game/Crowd/Character/Female/GroomBindings" };
...
void FCrowdCharacterOptions::GenerateCharacterDefinition(const UCrowdCharacterDataAsset* DataAsset, FCrowdCharacterDefinition& CharacterDefinition) const
{
	...
	{
		TArray<int> HairIndices = { HairIndex, EyebrowsIndex, FuzzIndex, EyelashesIndex, MustacheIndex, BeardIndex };
...
void FCrowdCharacterOptions::Randomize(const UCrowdCharacterDataAsset& DataAsset, TSet<ECrowdLineupVariation> FixedProperties)
{
...
void FCrowdCharacterOptions::Randomize(const UCrowdCharacterDataAsset& DataAsset, TSet<ECrowdLineupVariation> FixedProperties, const FRandomStream& RandomStream)
{
