...
FCrowdCharacterDefinition  UCrowdCharacterDataAsset::GetCharacterDefinitionFromIndex(const int32 GlobalIndex) const
{
	...
	return GetCharacterDefinition(Genders[GenderIndex], BodyTypes[BodyTypeIndex], GlobalIndex, GlobalIndex, GlobalIndex, GlobalIndex, GlobalIndex, GlobalIndex, GlobalIndex, GlobalIndex, GlobalIndex);
}
...
TArray<UGroomAsset*> UCrowdCharacterDataAsset::FindGrooms(const bool bMale, const bool bFemale, const bool bHair, const bool bEyebrows, const bool bFuzz, const bool bEyelashes, const bool bMustache, const bool bBeard) const
{
...
TArray<UStaticMesh*> UCrowdCharacterDataAsset::FindGroomMeshes(const bool bMale, const bool bFemale, const bool bHair, const bool bEyebrows, const bool bFuzz, const bool bEyelashes, const bool bMustache, const bool bBeard, const int32 GroupIndex) const
{
