...
public:
	...
	UFUNCTION(BlueprintCallable)
	void Randomize(UCrowdCharacterDataAsset* CrowdDataAsset, int32 NumPresets, const FCrowdCharacterOptions& BaseOptions, TArray<ECrowdLineupVariation> FixedOptions);
};
