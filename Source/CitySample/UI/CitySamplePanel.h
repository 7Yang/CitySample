...
public:
	...
	*/
	...
	UCitySamplePanel* GetParentPanel() const { return Parent; }

	/** Returns the list of dynamically added CitySamplePanel instances contained by this one. */
	UFUNCTION(BlueprintPure, Category = "CitySamplePanel")
	const TArray<UCitySamplePanel*>& GetChildPanels() const { return ChildPanels; }
	...
	UFUNCTION(BlueprintPure, Category = "CitySamplePanel")
	UCitySamplePanel* GetActivePanel() { return !ChildPanels.IsEmpty() ? ChildPanels.Last() : this ; }
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "CitySamplePanel")
	bool IsHidingAllPanels() const { return bIsHidingAllPanels; }
	...
	UFUNCTION(BlueprintPure, Category = "CitySamplePanel")
	ECitySampleControlsFlavor GetControlsFlavor() const { return ControlsFlavor; }
	...
	virtual	bool HasControlsFlavor() const { return true; }
	...
	FCitySamplePanelControlsFlavorChangedEvent& OnControlsFlavorChanged() { return ControlsFlavorChangedEvent; }
...
protected:
	...
	virtual void NativeOnAddedChildPanel(UCitySamplePanel* ChildPanel) { OnAddedChildPanel(ChildPanel); }
	...
	virtual void NativeOnAddedToPanel() { OnAddedToPanel(); }
	...
	virtual void NativeOnRemoveChildPanel(UCitySamplePanel* ChildPanel) { OnRemoveChildPanel(ChildPanel); }
	...
	virtual void NativeOnRemoveFromPanel() { OnRemoveFromPanel(); }
