...
public:
	...
	bool IsHidingUI() { return BasePanel && BasePanel->IsHidingAllPanels(); }

	/** Returns the root CitySamplePanel instance. */
	UFUNCTION(BlueprintPure, Category = "CitySample UI")
	UCitySamplePanel* GetBasePanel() const { return BasePanel; }

	/** Returns the options menu CitySamplePanel instance. */
	UFUNCTION(BlueprintPure, Category = "CitySample UI")
	UCitySampleMenu* GetOptionsMenu() const { return OptionsMenu; }

	/** Returns the controls overlay CitySamplePanel instance used to display context relevant input options. */
	UFUNCTION(BlueprintPure, Category = "CitySample UI")
	UCitySampleControlsOverlay* GetControlsOverlay() const { return ControlsOverlay; }

	/** Returns the interaction prompt widget. */
	UFUNCTION(BlueprintPure, Category = "CitySample UI")
	UUserWidget* GetInteractionPrompt() const { return PromptWidget; }
	...
	UFUNCTION(BlueprintPure, Category = "CitySample UI")
	bool IsOptionsMenuActive() const { return bOptionsMenuActive; }
	...
	UFUNCTION(BlueprintPure, Category = "CitySample UI")
	bool IsControlsOverlayActive() const { return bControlsOverlayActive; }
	...
	UFUNCTION(BlueprintPure, Category = "CitySample UI")
	bool IsInteractPromptActive() const { return bInteractPromptActive; }
