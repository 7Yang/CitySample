...
void ACitySampleMassVehicleBase::ApplyWheelMotionBlurNative(const TArray<UMaterialInstanceDynamic*>& MotionBlurMIDs, UMassTrafficVehicleComponent* MassTrafficVehicleComponent, int32 WheelMotionBlurNumSpokes, float WheelMotionBlurStartBlurSpeed, float WheelMotionBlurMin, float WheelMotionBlurMax)
{
