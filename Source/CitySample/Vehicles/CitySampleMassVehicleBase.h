...
public:
	...
	void ApplyWheelMotionBlurNative(const TArray<UMaterialInstanceDynamic*>& MotionBlurMIDs, class UMassTrafficVehicleComponent* MassTrafficVehicleComponent, int32 WheelMotionBlurNumSpokes, float WheelMotionBlurStartBlurSpeed, float WheelMotionBlurMin, float WheelMotionBlurMax);
