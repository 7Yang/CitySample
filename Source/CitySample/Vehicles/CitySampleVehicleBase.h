...
struct FTimestampedTransform
{
    ...
    FTimestampedTransform() = default;

	FTimestampedTransform(float _TimeStamp, FTransform _Transform) 
        : TimeStamp(_TimeStamp), Transform(_Transform)
	{ }
...
public:
	...
	virtual EPlayerTraversalState GetTraversalState_Implementation() const override { return EPlayerTraversalState::InVehicle; }
	...
	const FCitySampleDrivingState& GetDrivingState() const { return DrivingState; }

	UFUNCTION(BlueprintCallable, Category = "Driving")
	FVector GetMeasuredVelocity() const { return MeasuredVelocity; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	float GetThrottleInput() const { return DrivingState.Throttle; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	float GetBrakeInput() const { return DrivingState.Brake; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	bool IsHandbrakeOn() const { return DrivingState.bHandbrakeOn; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	float GetForwardSpeed() const { return DrivingState.ForwardSpeed; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	float GetRPM() const { return DrivingState.RPM; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	int32 GetGear() const { return DrivingState.Gear; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	bool IsUsingAutoGears() const { return DrivingState.bAutomatic; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	bool HasAllWheelsOnGround() const { return DrivingState.bAllWheelsOnGround; }

	UFUNCTION(BlueprintPure, Category = "Driving")
	bool ShouldHideDrivingUI() const { return bHideDrivingUI; }

	UFUNCTION(BlueprintCallable, Category = "Driving")
	void RequestHideDrivingUI(const bool bShouldHideDrivingUI) { bHideDrivingUI = bShouldHideDrivingUI; }

	UFUNCTION(BlueprintPure, Category = Pawn)
	virtual bool IsPossessableByPlayer() const { return bIsPossessableByPlayer; }

	UFUNCTION(BlueprintPure)
	bool IsPossessedByPlayer() const { return bIsPossessedByPlayer; }

	UFUNCTION(BlueprintPure)
	float GetTimeSpentSharpSteering() const { return TimeSpentSharpSteering; }

	UFUNCTION(BlueprintPure, Category = "Camera Overriddes")
	bool ShouldOverrideCameraToPivotOffset() const { return bOverrideCameraToPivotOffset; }

	UFUNCTION(BlueprintPure, Category = "Camera Overriddes")
	bool ShouldOverrideLookAtPointOffset() const { return bOverrideLookAtPointOffset; }

	UFUNCTION(BlueprintPure, Category = "Camera Overriddes")
	const FVector& GetCameraToPivotOffsetOverride() const { return CameraToPivotOffsetOverride; }

	UFUNCTION(BlueprintPure, Category = "Camera Overriddes")
	const FVector& GetLookAtPointOffsetOverride() const { return LookAtPointOffsetOverride; }
	...
	void SetThrottleDisabled(bool IsDisabled) { bThrottleDisabled = IsDisabled; }
