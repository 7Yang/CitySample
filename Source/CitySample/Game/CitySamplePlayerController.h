...
public:
	...
	virtual APawn* GetInteractingPawn() override { return GetPawn(); }
	...
	UCitySampleUIComponent* GetCitySampleUIComponent() const { return CitySampleUIComponent; }

	UFUNCTION(BlueprintCallable)
	UPhotoModeComponent* GetPhotoModeComponent() const { return PhotoModeComponent; }

	UFUNCTION(BlueprintPure, Category = "Vehicle")
	AActor* GetCurrentPlayerVehicle() const { return CurrentPlayerVehicle; }

	const FMassEntityHandle& GetCurrentPlayerVehicleMassHandle() const { return CurrentPlayerVehicleMassHandle; }
	...
	UClass* GetDronePawnClass() const { return DronePawnClass.Get(); }

	UFUNCTION(BlueprintCallable)
	float GetCameraTransitionLevelStreamDistance2D() const { return CameraTransitionLevelStreamDistance2D; }

	UFUNCTION(BlueprintCallable)
	void SetCanPerformInteractions(bool bNewCanPerformInteractions) { bCanPerformInteractions = bNewCanPerformInteractions; }

	UFUNCTION(BlueprintPure)
	bool CanPerformInteractions() const { return bCanPerformInteractions; }
	...
	bool RotationInputWasZero() const { return LastRotationInput.IsNearlyZero(); }
