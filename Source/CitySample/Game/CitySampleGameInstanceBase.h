...
public:
	...
	UCitySampleSaveGame* GetSaveGame() { return SaveGame; }
	...
	UFUNCTION(BlueprintPure, Category="SaveGame")
	bool IsSaveGameLoaded() const { return bSaveGameLoaded; }
	...
	UTexture* GetBaseGroomTexture() const  { return BaseGroomTexture.LoadSynchronous(); }
	UTexture* GetBaseFollicleMaskTexture() { return BaseFollicleMaskTexture.LoadSynchronous(); }
